...
import com.attendcrew.app.ui.workers.WorkerAttendanceScreen
import com.attendcrew.app.ui.splash.SplashScreen
import java.net.URLDecoder
import java.nio.charset.StandardCharsets

private fun decodeArg(arg: String?): String = URLDecoder.decode(arg ?: "", StandardCharsets.UTF_8.toString())
...
fun AppNavGraph(
    ...
    NavHost(navController = navController, startDestination = "splash") {
        ...
        composable(route = "worker_attendance/{workerId}/{workerName}") { back ->
            val workerId =back.arguments?.getString("workerId") ?: ""
            val workerName =decodeArg(back.arguments?.getString("workerName"))
            WorkerAttendanceScreen(navController = navController,workerId = workerId,workerName = workerName)
        }
